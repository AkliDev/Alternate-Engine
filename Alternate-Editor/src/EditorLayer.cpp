...
namespace Alternate
{
	...
	void EditorLayer::OnUpdate(Timestep ts)
	{
		...
		switch (m_SceneState)
		{
			...
			case SceneState::Simulate:
			{
				...
				m_ActiveScene->OnSimulationUpdate(ts, m_EditorCamera);
				break;
			}
	...
	void EditorLayer::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseButtonPressedEvent>(ALT_BIND_EVENT_FN(EditorLayer::OnMouseButtonPressed));
	}
	...
	{
		ALT_CORE_ASSERT(m_SceneState == SceneState::Play || m_SceneState == SceneState::Simulate);
